...
def main() -> int:
    ...
    if not data["found"]:
        ...
        # printed a shrug and returned success — which is how a reader becomes decorative.
        print(f"🔴 SENSOR NOT FOUND at {data['transcripts_dir']}\n"
              f"   Claude Code flattens both '/' and '_' to '-' in this path. If the repo moved or "
              f"was renamed, fix the derivation — do not delete the check.")
        return 1
