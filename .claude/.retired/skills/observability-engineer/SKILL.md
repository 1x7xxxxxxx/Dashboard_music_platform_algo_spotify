...
description: Monitoring, logging and tracing systems with SLI/SLO management and incident workflows. Use when the user mentions observability, OpenTelemetry, distributed tracing, SLO, Prometheus, alerting, dashboards, or incident response. Not for optimising application performance itself — it instruments, it does not tune. Assumes a running service that can be instrumented.
---
