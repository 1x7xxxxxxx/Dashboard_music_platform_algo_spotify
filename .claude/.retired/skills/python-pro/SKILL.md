---
name: python-pro
description: "Modern Python 3.12+ idiom: typing, async, packaging and the uv/ruff/pydantic toolchain. Use when writing or reviewing Python and the question concerns idiom, type hints, async patterns, dependency management, or performance. Not for machine-learning modelling code, and not a general code reviewer. Assumes Python 3.12 or newer."
---
