---
name: docker-expert
description: Container optimisation, security hardening, multi-stage builds and production image practices. Use when the user mentions Dockerfile, docker-compose, image size, container security, multi-stage build, or asks to containerise a service. Not for Kubernetes cluster operations or CI pipeline design. Assumes a Dockerfile or compose file exists or is about to be written.
---
