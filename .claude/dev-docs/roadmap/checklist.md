...
- [ ] **Drop to the 11-feature contract** — the deferred skew fix: removing the 2 never-served features costs ≤0.004 AUC (`COMPARISON_REPORT.md` §3) and makes offline metrics = production reality. Revisit alongside Phase-2 (decide: drop, or finally serve them live).
