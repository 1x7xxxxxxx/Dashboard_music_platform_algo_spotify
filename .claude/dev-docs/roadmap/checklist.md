...
3. **Stripe** : basculer en mode **live opérationnel** = rembourser/garder le 1ᵉʳ paiement test, archiver le prix doublon, et surveiller le 1ᵉʳ vrai client.

*Session 2026-06-13 (suite 12) : Stripe live prouvé + 3 bugs corrigés (nav login-bounce PR #46, date période PR #47, fuite fraîcheur Spotify PR #48) + audit isolation tenant complet (PR #49 : API `require_artist_scope` + 4 P3) + `/ml/predictions` réparé & P4 fermée.*
