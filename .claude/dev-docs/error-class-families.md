...
**319 classes**, regroupées en **17 familles** par une règle explicite, écrite sous chaque titre. Aucune entrée de `.claude/dev-docs/error-classes.md` n'est modifiée : le catalogue est append-only, cette taxonomie vit à côté.
...
<!-- error-class-families: total=319 families=17 orphans=3 -->

<!-- error-class-families: sha256=e9b9b2e35434709c91130ff2acb065464cd00aee37d89e2f8fc90073c6def9fd -->
