...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (380 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 140 |
| `guard_does_not_prove_itself` | 284 |
...
| by_seen_red · daté | 10 | 0.0844 | 0.0404 – 0.1551 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1924 | 0.1433 – 0.253 | insuffisant pour conclure (n=61) |
