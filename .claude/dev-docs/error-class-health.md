...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (442 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 245 |
...
| by_seen_red · daté | 10 | 0.0949 | 0.0454 – 0.1745 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1833 | 0.1365 – 0.241 | insuffisant pour conclure (n=61) |
