...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (457 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 219 |
...
| by_seen_red · daté | 8 | 0.0803 | 0.0346 – 0.1582 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 53 | 0.1867 | 0.1398 – 0.2442 | insuffisant pour conclure (n=61) |
