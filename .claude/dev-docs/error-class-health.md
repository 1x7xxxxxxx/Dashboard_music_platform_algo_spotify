...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (432 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 263 |
...
| by_seen_red · daté | 10 | 0.0894 | 0.0428 – 0.1645 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1877 | 0.1397 – 0.2467 | insuffisant pour conclure (n=61) |
