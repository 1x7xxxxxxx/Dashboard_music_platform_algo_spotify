...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (487 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 144 |
...
| by_seen_red · daté | 6 | 0.0863 | 0.0315 – 0.1878 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1751 | 0.1319 – 0.228 | insuffisant pour conclure (n=61) |
