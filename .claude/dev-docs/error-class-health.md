...
**378 classes.** Fenêtre observée : `2026-05-15` → `2026-09-17` (215 révisions du catalogue rejouées).
...
| avancé | mesuré |
|---|---|
| 367 classes | **378** — les 4 en trop étaient `Contract`, `Index`, `Per-class schema`, `CLASS-ID` |
