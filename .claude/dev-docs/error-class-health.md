...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (491 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 132 |
...
| by_seen_red · daté | 6 | 0.1041 | 0.038 – 0.2265 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1688 | 0.1271 – 0.2197 | insuffisant pour conclure (n=61) |
