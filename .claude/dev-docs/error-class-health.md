...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (404 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 91 |
| `guard_does_not_prove_itself` | 270 |
...
| by_seen_red · daté | 10 | 0.0881 | 0.0422 – 0.162 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1889 | 0.1406 – 0.2483 | insuffisant pour conclure (n=61) |
