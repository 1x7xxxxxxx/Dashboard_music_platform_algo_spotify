...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (478 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 170 |
...
| by_seen_red · daté | 7 | 0.0735 | 0.0295 – 0.1515 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 54 | 0.1872 | 0.1407 – 0.2443 | insuffisant pour conclure (n=61) |
