...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (542 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 42 |
| `guards_ref_missing` | 0 |
| `scope_family_invalid` | 0 |
| `scope_on_a_shared_guard_without_naming_its_tests` | 14 |
| `scope_unknown` | 0 |
...
| by_seen_red · daté | 4 | 0.1412 | 0.038 – 0.3616 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 57 | 0.1604 | 0.1215 – 0.2079 | insuffisant pour conclure (n=61) |
