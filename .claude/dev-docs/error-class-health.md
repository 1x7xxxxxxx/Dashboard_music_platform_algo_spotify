...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (507 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 91 |
...
| by_seen_red · daté | 5 | 0.1205 | 0.0388 – 0.2813 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1637 | 0.1236 – 0.2126 | insuffisant pour conclure (n=61) |
