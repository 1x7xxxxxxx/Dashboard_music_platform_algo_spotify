...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (448 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 237 |
...
| by_seen_red · daté | 10 | 0.0974 | 0.0466 – 0.1791 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1815 | 0.1352 – 0.2387 | insuffisant pour conclure (n=61) |
