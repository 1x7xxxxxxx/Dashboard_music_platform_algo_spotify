...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (517 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 73 |
...
| by_seen_red · daté | 5 | 0.1376 | 0.0443 – 0.321 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1613 | 0.1218 – 0.2094 | insuffisant pour conclure (n=61) |
