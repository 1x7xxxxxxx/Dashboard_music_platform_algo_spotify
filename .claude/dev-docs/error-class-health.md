...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (533 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 53 |
...
| by_seen_red · daté | 4 | 0.1329 | 0.0358 – 0.3402 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 57 | 0.1613 | 0.1221 – 0.2089 | insuffisant pour conclure (n=61) |
