...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (479 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 167 |
...
| by_seen_red · daté | 7 | 0.0753 | 0.0302 – 0.1552 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 54 | 0.1858 | 0.1396 – 0.2424 | insuffisant pour conclure (n=61) |
