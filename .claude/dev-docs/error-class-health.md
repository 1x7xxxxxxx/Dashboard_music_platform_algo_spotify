...
**394 classes.** Fenêtre observée : `2026-05-15` → `2026-09-17` (239 révisions du catalogue rejouées).
...
| by_scope · ne-couvre-pas renseigné | 60 | 0.3559 | 0.2716 – 0.4581 | **séparent** |
| by_scope · non renseigné | 0 | 0.0 | 0.0 – 0.0388 | **séparent** |
