...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (382 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 140 |
| `guard_does_not_prove_itself` | 278 |
...
| by_seen_red · daté | 10 | 0.0862 | 0.0413 – 0.1585 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1906 | 0.1419 – 0.2506 | insuffisant pour conclure (n=61) |
