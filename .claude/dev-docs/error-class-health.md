...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (521 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 68 |
...
| by_seen_red · daté | 5 | 0.1421 | 0.0458 – 0.3315 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1607 | 0.1214 – 0.2087 | insuffisant pour conclure (n=61) |
