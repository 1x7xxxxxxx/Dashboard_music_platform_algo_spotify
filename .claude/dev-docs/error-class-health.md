...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (498 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 115 |
...
| by_seen_red · daté | 6 | 0.1243 | 0.0454 – 0.2706 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.164 | 0.1236 – 0.2135 | insuffisant pour conclure (n=61) |
