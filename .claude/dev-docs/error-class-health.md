...
**394 classes.** Fenêtre observée : `2026-05-15` → `2026-09-17` (238 révisions du catalogue rejouées).
...
| `scope_on_a_shared_guard_without_naming_its_tests` | 12 |
| `scope_unknown` | 0 |
...
| by_scope · ne-couvre-pas renseigné | 60 | 0.3794 | 0.2895 – 0.4884 | **séparent** |
| by_scope · non renseigné | 0 | 0.0 | 0.0 – 0.035 | **séparent** |
