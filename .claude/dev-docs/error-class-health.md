...
**394 classes.** Fenêtre observée : `2026-05-15` → `2026-09-17` (237 révisions du catalogue rejouées).
...
| by_scope · ne-couvre-pas renseigné | 60 | 0.4039 | 0.3082 – 0.5199 | **séparent** |
| by_scope · non renseigné | 0 | 0.0 | 0.0 – 0.032 | **séparent** |
