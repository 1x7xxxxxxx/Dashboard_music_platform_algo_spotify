...
**398 classes.** Fenêtre observée : `2026-05-15` → `2026-09-18` (286 révisions du catalogue rejouées).
...
|---|---|
| balayages faits | **292** |
| dont le verdict est LISIBLE | **191** |
| qui ont trouvé au moins un site | **21** |
| sites vivants trouvés | **52** |
| taux de trouvaille (sur verdicts lisibles) | **0.11** |
...
| by_seen_red · daté | 9 | 0.387 | 0.1766 – 0.7347 | insuffisant pour conclure (n=66) |
| by_seen_red · jamais-ou-inconnu | 57 | 0.2254 | 0.1707 – 0.2921 | insuffisant pour conclure (n=66) |
