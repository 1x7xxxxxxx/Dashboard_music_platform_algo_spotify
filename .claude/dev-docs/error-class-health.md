...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (493 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 126 |
...
| by_seen_red · daté | 6 | 0.1115 | 0.0407 – 0.2427 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1668 | 0.1256 – 0.2171 | insuffisant pour conclure (n=61) |
