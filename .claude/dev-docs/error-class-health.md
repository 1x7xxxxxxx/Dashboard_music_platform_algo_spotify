...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (508 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 89 |
...
| by_seen_red · daté | 5 | 0.1221 | 0.0393 – 0.2849 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1634 | 0.1235 – 0.2122 | insuffisant pour conclure (n=61) |
