...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (481 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 161 |
...
| by_seen_red · daté | 7 | 0.082 | 0.0329 – 0.169 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 54 | 0.1811 | 0.136 – 0.2362 | insuffisant pour conclure (n=61) |
