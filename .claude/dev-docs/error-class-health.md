...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (497 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 117 |
...
| by_seen_red · daté | 6 | 0.1218 | 0.0445 – 0.265 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1645 | 0.1239 – 0.2141 | insuffisant pour conclure (n=61) |
