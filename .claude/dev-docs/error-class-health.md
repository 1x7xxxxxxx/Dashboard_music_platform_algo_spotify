...
|---|---|
| balayages faits | **340** |
| dont le verdict est LISIBLE | **240** |
| qui ont trouvé au moins un site | **36** |
| sites vivants trouvés | **86** |
| taux de trouvaille (sur verdicts lisibles) | **0.15** |

⚠️ **97 des 340 « balayages » n'en sont PAS** : ils disent que le garde a été relancé et qu'il était vert. Un garde vert prouve que SON prédicat ne trouve rien, jamais qu'il n'y a rien — mesuré trois fois la nuit du 17 au 18, dont un garde vert sur **8 sites vivants**. Le nombre de classes dont personne n'a cherché les frères est donc **157**, et non 60.
...
| `seen_red_never` | 0 |
| `seen_red_unknown` | 273 |
| `siblings_never_swept` | 60 |
| `sites_unknown` | 100 |
...
| by_seen_red · daté | 16 | 0.2723 | 0.1556 – 0.4423 | insuffisant pour conclure (n=42) |
| by_seen_red · jamais-ou-inconnu | 26 | 0.1196 | 0.0781 – 0.1753 | insuffisant pour conclure (n=42) |
