...
**394 classes.** Fenêtre observée : `2026-05-15` → `2026-09-17` (229 révisions du catalogue rejouées).
...
| by_scope · ne-couvre-pas renseigné | 60 | 0.7872 | 0.6007 – 1.0133 | **séparent** |
| by_scope · non renseigné | 0 | 0.0 | 0.0 – 0.0196 | **séparent** |
