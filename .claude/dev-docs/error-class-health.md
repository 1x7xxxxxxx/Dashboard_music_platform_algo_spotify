...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (378 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 140 |
| `guard_does_not_prove_itself` | 292 |
...
| by_seen_red · daté | 10 | 0.0828 | 0.0397 – 0.1523 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.194 | 0.1444 – 0.2551 | insuffisant pour conclure (n=61) |
