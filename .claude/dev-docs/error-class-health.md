...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (516 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 74 |
...
| by_seen_red · daté | 5 | 0.1364 | 0.044 – 0.3184 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1614 | 0.1219 – 0.2096 | insuffisant pour conclure (n=61) |
