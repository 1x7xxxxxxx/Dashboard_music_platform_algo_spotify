...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (510 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 84 |
...
| by_seen_red · daté | 5 | 0.129 | 0.0416 – 0.3011 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1624 | 0.1227 – 0.2109 | insuffisant pour conclure (n=61) |
