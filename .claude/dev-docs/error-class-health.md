...
**377 classes.** Fenêtre observée : `2026-05-15` → `2026-09-17` (209 révisions du catalogue rejouées).
...
| avancé | mesuré |
|---|---|
| 367 classes | **377** — les 4 en trop étaient `Contract`, `Index`, `Per-class schema`, `CLASS-ID` |
...
| by_scope · ne-couvre-pas renseigné | 58 | 0.9098 | 0.6908 – 1.1762 | **séparent** |
