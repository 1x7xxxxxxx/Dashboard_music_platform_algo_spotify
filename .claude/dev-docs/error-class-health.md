...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (494 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 123 |
...
| by_seen_red · daté | 6 | 0.1151 | 0.042 – 0.2505 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1659 | 0.125 – 0.216 | insuffisant pour conclure (n=61) |
