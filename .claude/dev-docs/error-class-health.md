...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (532 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 54 |
...
| by_seen_red · daté | 4 | 0.1309 | 0.0352 – 0.3351 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 57 | 0.1615 | 0.1223 – 0.2092 | insuffisant pour conclure (n=61) |
