...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (536 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 51 |
...
| by_seen_red · daté | 4 | 0.1376 | 0.037 – 0.3522 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 57 | 0.1608 | 0.1218 – 0.2083 | insuffisant pour conclure (n=61) |
