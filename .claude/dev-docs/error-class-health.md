...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (490 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 135 |
...
| by_seen_red · daté | 6 | 0.1005 | 0.0367 – 0.2187 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1698 | 0.1279 – 0.221 | insuffisant pour conclure (n=61) |
