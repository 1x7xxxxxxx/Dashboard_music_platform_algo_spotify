...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (471 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 185 |
...
| by_seen_red · daté | 8 | 0.0769 | 0.0331 – 0.1516 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 53 | 0.1896 | 0.142 – 0.2479 | insuffisant pour conclure (n=61) |
