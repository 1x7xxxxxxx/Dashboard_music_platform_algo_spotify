...
**400 classes.** Fenêtre observée : `2026-05-15` → `2026-09-18` (296 révisions du catalogue rejouées).
...
|---|---|
| balayages faits | **300** |
| dont le verdict est LISIBLE | **199** |
| qui ont trouvé au moins un site | **26** |
| sites vivants trouvés | **63** |
| taux de trouvaille (sur verdicts lisibles) | **0.131** |

⚠️ **97 des 300 « balayages » n'en sont PAS** : ils disent que le garde a été relancé et qu'il était vert. Un garde vert prouve que SON prédicat ne trouve rien, jamais qu'il n'y a rien — mesuré trois fois la nuit du 17 au 18, dont un garde vert sur **8 sites vivants**. Le nombre de classes dont personne n'a cherché les frères est donc **197**, et non 100.
...
| `siblings_never_swept` | 100 |
| `sites_unknown` | 101 |
| `swept_by_rerunning_the_guard` | 97 |

## Récidive observée

**32 évènements** sur 8394 classe-jours d'exposition — **0.1159** par classe-mois (IC 95 % : 0.0793 – 0.1636)

### Par strate

| strate | évènements | par classe-mois | IC 95 % | verdict |
|---|---|---|---|---|
| by_guard · automatique | 29 | 0.1072 | 0.0718 – 0.154 | insuffisant pour conclure (n=32) |
| by_guard · prose | 3 | 0.5272 | 0.106 – 1.5403 | insuffisant pour conclure (n=32) |
| by_seen_red · daté | 7 | 0.2099 | 0.0841 – 0.4324 | insuffisant pour conclure (n=32) |
| by_seen_red · jamais-ou-inconnu | 25 | 0.103 | 0.0666 – 0.152 | insuffisant pour conclure (n=32) |
| by_scope · ne-couvre-pas renseigné | 32 | 0.1159 | 0.0793 – 0.1636 | une seule strate peuplée (n=32) |
