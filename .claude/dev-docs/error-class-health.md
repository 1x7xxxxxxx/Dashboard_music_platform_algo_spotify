...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (518 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 72 |
...
| by_seen_red · daté | 5 | 0.1396 | 0.045 – 0.3257 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.161 | 0.1216 – 0.2091 | insuffisant pour conclure (n=61) |
