...
**401 classes.** Fenêtre observée : `2026-05-15` → `2026-09-18` (330 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 140 |
| `guard_does_not_prove_itself` | 307 |
...
| by_seen_red · daté | 16 | 0.1854 | 0.1059 – 0.3012 | insuffisant pour conclure (n=43) |
