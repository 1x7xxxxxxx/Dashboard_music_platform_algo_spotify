...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (485 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 150 |
...
| by_seen_red · daté | 6 | 0.0781 | 0.0285 – 0.17 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1793 | 0.1351 – 0.2334 | insuffisant pour conclure (n=61) |
