...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (447 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 238 |
...
| by_seen_red · daté | 10 | 0.0971 | 0.0465 – 0.1786 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1818 | 0.1353 – 0.239 | insuffisant pour conclure (n=61) |
