...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (492 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 129 |
...
| by_seen_red · daté | 6 | 0.1074 | 0.0392 – 0.2337 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1678 | 0.1264 – 0.2185 | insuffisant pour conclure (n=61) |
