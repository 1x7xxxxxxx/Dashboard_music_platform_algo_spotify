...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (520 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 70 |
...
| by_seen_red · daté | 5 | 0.1409 | 0.0454 – 0.3287 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1609 | 0.1215 – 0.2089 | insuffisant pour conclure (n=61) |
