...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (505 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 97 |
...
| by_seen_red · daté | 5 | 0.1159 | 0.0373 – 0.2704 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1645 | 0.1243 – 0.2136 | insuffisant pour conclure (n=61) |
