...
**400 classes.** Fenêtre observée : `2026-05-15` → `2026-09-18` (310 révisions du catalogue rejouées).
...
|---|---|
| balayages faits | **366** |
| dont le verdict est LISIBLE | **266** |
| qui ont trouvé au moins un site | **36** |
| sites vivants trouvés | **86** |
| taux de trouvaille (sur verdicts lisibles) | **0.135** |

⚠️ **97 des 366 « balayages » n'en sont PAS** : ils disent que le garde a été relancé et qu'il était vert. Un garde vert prouve que SON prédicat ne trouve rien, jamais qu'il n'y a rien — mesuré trois fois la nuit du 17 au 18, dont un garde vert sur **8 sites vivants**. Le nombre de classes dont personne n'a cherché les frères est donc **131**, et non 34.
...
| `seen_red_never` | 0 |
| `seen_red_unknown` | 253 |
| `siblings_never_swept` | 34 |
| `sites_unknown` | 100 |
...
| by_seen_red · daté | 16 | 0.2185 | 0.1248 – 0.3549 | insuffisant pour conclure (n=42) |
| by_seen_red · jamais-ou-inconnu | 26 | 0.1281 | 0.0837 – 0.1878 | insuffisant pour conclure (n=42) |
