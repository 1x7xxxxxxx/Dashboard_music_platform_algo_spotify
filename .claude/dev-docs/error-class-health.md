...
**394 classes.** Fenêtre observée : `2026-05-15` → `2026-09-17` (243 révisions du catalogue rejouées).
...
| `scope_on_a_shared_guard_without_naming_its_tests` | 23 |
| `scope_unknown` | 0 |
...
| by_scope · ne-couvre-pas renseigné | 60 | 0.2554 | 0.1949 – 0.3287 | **séparent** |
| by_scope · non renseigné | 0 | 0.0 | 0.0 – 0.1306 | **séparent** |
