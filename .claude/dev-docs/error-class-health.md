...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (496 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 119 |
...
| by_seen_red · daté | 6 | 0.1206 | 0.0441 – 0.2626 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1647 | 0.1241 – 0.2144 | insuffisant pour conclure (n=61) |
