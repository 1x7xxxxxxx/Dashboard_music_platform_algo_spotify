...
|---|---|
| balayages faits | **360** |
| dont le verdict est LISIBLE | **260** |
| qui ont trouvé au moins un site | **36** |
| sites vivants trouvés | **86** |
| taux de trouvaille (sur verdicts lisibles) | **0.138** |

⚠️ **97 des 360 « balayages » n'en sont PAS** : ils disent que le garde a été relancé et qu'il était vert. Un garde vert prouve que SON prédicat ne trouve rien, jamais qu'il n'y a rien — mesuré trois fois la nuit du 17 au 18, dont un garde vert sur **8 sites vivants**. Le nombre de classes dont personne n'a cherché les frères est donc **137**, et non 40.
...
| `seen_red_never` | 0 |
| `seen_red_unknown` | 258 |
| `siblings_never_swept` | 40 |
| `sites_unknown` | 100 |
...
| by_seen_red · daté | 16 | 0.2346 | 0.134 – 0.3811 | insuffisant pour conclure (n=42) |
| by_seen_red · jamais-ou-inconnu | 26 | 0.125 | 0.0817 – 0.1832 | insuffisant pour conclure (n=42) |
