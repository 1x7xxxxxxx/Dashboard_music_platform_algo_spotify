...
**394 classes.** Fenêtre observée : `2026-05-15` → `2026-09-17` (230 révisions du catalogue rejouées).
...
| by_scope · ne-couvre-pas renseigné | 60 | 0.7032 | 0.5366 – 0.9051 | **séparent** |
| by_scope · non renseigné | 0 | 0.0 | 0.0 – 0.0206 | **séparent** |
