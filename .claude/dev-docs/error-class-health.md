...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (433 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 261 |
...
| by_seen_red · daté | 10 | 0.0899 | 0.043 – 0.1654 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1872 | 0.1394 – 0.2462 | insuffisant pour conclure (n=61) |
