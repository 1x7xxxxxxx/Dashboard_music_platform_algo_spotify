...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (437 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 256 |
...
| by_seen_red · daté | 10 | 0.0909 | 0.0435 – 0.1672 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1864 | 0.1388 – 0.2451 | insuffisant pour conclure (n=61) |
