...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (431 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 264 |
...
| by_seen_red · daté | 10 | 0.0891 | 0.0426 – 0.1638 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.188 | 0.1399 – 0.2472 | insuffisant pour conclure (n=61) |
