...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (446 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 240 |
...
| by_seen_red · daté | 10 | 0.0965 | 0.0462 – 0.1775 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1821 | 0.1356 – 0.2395 | insuffisant pour conclure (n=61) |
