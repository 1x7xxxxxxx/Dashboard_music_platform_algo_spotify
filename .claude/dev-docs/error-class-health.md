...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (537 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 50 |
...
| by_seen_red · daté | 4 | 0.1398 | 0.0376 – 0.3578 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 57 | 0.1606 | 0.1216 – 0.2081 | insuffisant pour conclure (n=61) |
