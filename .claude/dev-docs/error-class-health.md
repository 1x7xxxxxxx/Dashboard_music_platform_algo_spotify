...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (530 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 57 |
...
| by_seen_red · daté | 5 | 0.1476 | 0.0476 – 0.3444 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1601 | 0.121 – 0.208 | insuffisant pour conclure (n=61) |
