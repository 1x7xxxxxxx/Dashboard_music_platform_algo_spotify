...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (501 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 108 |
...
| by_seen_red · daté | 6 | 0.1299 | 0.0474 – 0.2828 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.163 | 0.1228 – 0.2122 | insuffisant pour conclure (n=61) |
