...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (506 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 93 |
...
| by_seen_red · daté | 5 | 0.1183 | 0.0381 – 0.276 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 56 | 0.1641 | 0.1239 – 0.2131 | insuffisant pour conclure (n=61) |
