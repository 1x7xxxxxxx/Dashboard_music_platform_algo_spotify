...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (381 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 140 |
| `guard_does_not_prove_itself` | 281 |
...
| by_seen_red · daté | 10 | 0.0857 | 0.041 – 0.1577 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1911 | 0.1422 – 0.2512 | insuffisant pour conclure (n=61) |
