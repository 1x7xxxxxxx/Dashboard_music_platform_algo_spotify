...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (549 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 35 |
...
| by_seen_red · daté | 3 | 0.1244 | 0.025 – 0.3635 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 58 | 0.1613 | 0.1225 – 0.2086 | insuffisant pour conclure (n=61) |
