...
**400 classes.** Fenêtre observée : `2026-05-15` → `2026-09-18` (306 révisions du catalogue rejouées).
...
|---|---|
| balayages faits | **347** |
| dont le verdict est LISIBLE | **247** |
| qui ont trouvé au moins un site | **36** |
| sites vivants trouvés | **86** |
| taux de trouvaille (sur verdicts lisibles) | **0.146** |

⚠️ **97 des 347 « balayages » n'en sont PAS** : ils disent que le garde a été relancé et qu'il était vert. Un garde vert prouve que SON prédicat ne trouve rien, jamais qu'il n'y a rien — mesuré trois fois la nuit du 17 au 18, dont un garde vert sur **8 sites vivants**. Le nombre de classes dont personne n'a cherché les frères est donc **150**, et non 53.
...
| `seen_red_never` | 0 |
| `seen_red_unknown` | 267 |
| `siblings_never_swept` | 53 |
| `sites_unknown` | 100 |
...
| by_seen_red · daté | 16 | 0.2594 | 0.1482 – 0.4213 | insuffisant pour conclure (n=42) |
| by_seen_red · jamais-ou-inconnu | 26 | 0.1212 | 0.0792 – 0.1777 | insuffisant pour conclure (n=42) |
