...
**417 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (443 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 244 |
...
| by_seen_red · daté | 10 | 0.0958 | 0.0459 – 0.1762 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 51 | 0.1827 | 0.136 – 0.2402 | insuffisant pour conclure (n=61) |
