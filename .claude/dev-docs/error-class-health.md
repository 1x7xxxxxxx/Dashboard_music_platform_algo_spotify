...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (482 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 158 |
...
| by_seen_red · daté | 6 | 0.0726 | 0.0265 – 0.158 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1828 | 0.1377 – 0.2379 | insuffisant pour conclure (n=61) |
