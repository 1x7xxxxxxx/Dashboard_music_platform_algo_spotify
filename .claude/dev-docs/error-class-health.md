...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (534 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 52 |
...
| by_seen_red · daté | 4 | 0.1351 | 0.0363 – 0.3459 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 57 | 0.161 | 0.122 – 0.2086 | insuffisant pour conclure (n=61) |
