...
| `cause_inferred` | 0 |
| `cause_unknown` | 140 |
| `guard_does_not_prove_itself` | 365 |
...
| by_seen_red · daté | 21 | 0.185 | 0.1145 – 0.2828 | insuffisant pour conclure (n=43) |
| by_seen_red · jamais-ou-inconnu | 22 | 0.1353 | 0.0848 – 0.2049 | insuffisant pour conclure (n=43) |
