...
**418 classes.** Fenêtre observée : `2026-05-15` → `2026-09-26` (484 révisions du catalogue rejouées).
...
| `cause_inferred` | 0 |
| `cause_unknown` | 13 |
| `guard_does_not_prove_itself` | 153 |
...
| by_seen_red · daté | 6 | 0.0759 | 0.0277 – 0.1653 | insuffisant pour conclure (n=61) |
| by_seen_red · jamais-ou-inconnu | 55 | 0.1806 | 0.136 – 0.2351 | insuffisant pour conclure (n=61) |
