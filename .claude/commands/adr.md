...
ADRs in this project cover: storage choices (QuestDB + PostgreSQL), CNC connectivity (Fanuc OPC UA), infrastructure (Docker Compose vs K8s), ML pipeline choices, security constraints (Airbus IT/OT), deployment decisions, schema lifecycle (Alembic, ADR-018).
