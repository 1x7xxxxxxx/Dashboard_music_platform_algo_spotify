...
_CEILINGS = {
    ...
    "seen_red_unknown": 137,  # 140 → 138 le 2026-09-25 ; → 137 le 2026-09-26 (R169)
    ...
    "guard_does_not_prove_itself": 297,  # 306 → 303 le 2026-09-25 (R169) ; → 300 le 2026-09-26 (migration P1 gardée, central-app + wrapper RTK auto-prouvants) ; → 297 (shared-db, replica, prose-claim)
    "seen_red_never": 0,
