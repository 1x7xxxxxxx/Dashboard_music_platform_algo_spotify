...
_CEILINGS = {
    ...
    "seen_red_unknown": 82,  # 140 → 138 le 2026-09-25 ; → 137 le 2026-09-26 (R169) ; → 134 ; → 133 ; → 132 ; → 131 ; → 130 ; → 129 ; → 128 ; → 127 ; → 126 ; → 125 ; → 124 ; → 123 ; → 122 ; → 119 ; → 117 ; → 116 ; → 115 ; → 114 ; → 114 ; → 113 ; → 110 ; → 109 ; → 106 ; → 103 ; → 100 ; → 97 ; → 94 ; → 91 ; → 88 ; → 85 ; → 82
    ...
    "guard_does_not_prove_itself": 201,  # 306 → 303 le 2026-09-25 (R169) ; → 300 le 2026-09-26 (migration P1 gardée, central-app + wrapper RTK auto-prouvants) ; → 297 (shared-db, replica, prose-claim) ; → 294 (collector, env, connexion par vue) ; → 292 (digest du guide, porte de dépendances) ; → 288 (4 preuves existantes enfin citées) ; → 285 ; → 284 ; → 281 ; → 278 ; → 276 ; → 274 ; → 270 ; → 268 ; → 266 ; → 264 ; → 263 ; → 261 ; → 259 ; → 258 ; → 257 ; → 256 ; → 255 ; → 253 ; → 249 ; → 247 ; → 245 ; → 244 ; → 243 ; → 242 ; → 240 ; → 238 ; → 237 ; → 236 ; → 235 ; → 234 ; → 231 ; → 228 ; → 225 ; → 222 ; → 219 ; → 216 ; → 213 ; → 210 ; → 207 ; → 204 ; → 201
    "seen_red_never": 0,
