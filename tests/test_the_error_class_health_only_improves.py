...
_CEILINGS = {
    ...
    "seen_red_unknown": 138,  # 140 → 138 le 2026-09-25 (R169 : 2 gardes rendus auto-prouvants)
    ...
    "guard_does_not_prove_itself": 300,  # 306 → 303 le 2026-09-25 (R169) ; → 300 le 2026-09-26 (migration P1 gardée, central-app + wrapper RTK auto-prouvants)
    "seen_red_never": 0,
