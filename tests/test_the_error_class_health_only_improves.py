...
_CEILINGS = {
    ...
    "cause_unknown": 9,  # 140 → 13 le 2026-09-26 (R169, causes lues dans le code) ; → 11 (mesurées : constante disparue, défaut de stackgaps) ; → 10 (40 trous au jour, 5 à la semaine) ; → 9 (titre : cause RÉTRACTÉE par mesure en navigateur) ; 182 → 181 le 2026-09-17 : `object-dtype-numeric-op` mesurée — `SUM(bigint)`
