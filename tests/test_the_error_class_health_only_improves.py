...
_CEILINGS = {
    ...
    "seen_red_unknown": 130,  # 140 → 138 le 2026-09-25 ; → 137 le 2026-09-26 (R169) ; → 134 ; → 133 ; → 132 ; → 131 ; → 130
    ...
    "guard_does_not_prove_itself": 278,  # 306 → 303 le 2026-09-25 (R169) ; → 300 le 2026-09-26 (migration P1 gardée, central-app + wrapper RTK auto-prouvants) ; → 297 (shared-db, replica, prose-claim) ; → 294 (collector, env, connexion par vue) ; → 292 (digest du guide, porte de dépendances) ; → 288 (4 preuves existantes enfin citées) ; → 285 ; → 284 ; → 281 ; → 278
    "seen_red_never": 0,
    ...
    "cause_unknown": 140,  # 182 → 181 le 2026-09-17 : `object-dtype-numeric-op` mesurée — `SUM(bigint)`
