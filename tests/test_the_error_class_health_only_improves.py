...
_CEILINGS = {
    ...
    "guard_does_not_prove_itself": 141,  # 306 → 303 le 2026-09-25 (R169) ; → 300 le 2026-09-26 (migration P1 gardée, central-app + wrapper RTK auto-prouvants) ; → 297 (shared-db, replica, prose-claim) ; → 294 (collector, env, connexion par vue) ; → 292 (digest du guide, porte de dépendances) ; → 288 (4 preuves existantes enfin citées) ; → 285 ; → 284 ; → 281 ; → 278 ; → 276 ; → 274 ; → 270 ; → 268 ; → 266 ; → 264 ; → 263 ; → 261 ; → 259 ; → 258 ; → 257 ; → 256 ; → 255 ; → 253 ; → 249 ; → 247 ; → 245 ; → 244 ; → 243 ; → 242 ; → 240 ; → 238 ; → 237 ; → 236 ; → 235 ; → 234 ; → 231 ; → 228 ; → 225 ; → 222 ; → 219 ; → 216 ; → 213 ; → 210 ; → 207 ; → 204 ; → 201 ; → 198 ; → 195 ; → 192 ; → 189 ; → 186 ; → 185 ; → 182 ; → 179 ; → 176 ; → 173 ; → 170 ; → 167 ; → 164 ; → 161 ; → 158 ; → 156 ; → 153 ; → 150 ; → 147 ; → 144 ; → 141
    "seen_red_never": 0,
