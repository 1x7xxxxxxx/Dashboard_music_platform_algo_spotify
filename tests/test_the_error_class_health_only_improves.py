...
_CEILINGS = {
    ...
    "cause_unknown": 11,  # 140 → 13 le 2026-09-26 (R169, causes lues dans le code) ; → 11 (mesurées : constante disparue, défaut de stackgaps) ; 182 → 181 le 2026-09-17 : `object-dtype-numeric-op` mesurée — `SUM(bigint)`
