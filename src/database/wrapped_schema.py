...
WRAPPED_SCHEMA = {
    'artist_wrapped': """
        CREATE TABLE IF NOT EXISTS artist_wrapped (
            ...
            countries INTEGER,
            listener_gain_pct DECIMAL(7, 2),
            stream_gain_pct DECIMAL(7, 2),
            save_gain_pct DECIMAL(7, 2),
            playlist_add_gain_pct DECIMAL(7, 2),
            saves BIGINT,
            playlist_adds BIGINT,
            top_fans_count INTEGER,
            top_fans_rank INTEGER,
