...
from src.dashboard.utils.login_buttons import (  # noqa: F401 — re-exported for tests
    _BUTTON_WIDTH_PX, _GOOGLE_BUTTON_CSS, _GOOGLE_BUTTON_KEY, _GOOGLE_G_LOGO,
    _LOGIN_BUTTON_KEY,
)
...
def _bouton_se_connecter() -> bool:
    """« Se connecter », seul bouton de soumission, sous les champs, sur leur bord gauche."""
