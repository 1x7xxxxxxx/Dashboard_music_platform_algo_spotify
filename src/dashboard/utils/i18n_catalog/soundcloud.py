...
EN = {
    ...
    "soundcloud.kpi_tracks": "🎵 Tracks online",
    "soundcloud.kpi_last_update": "📅 Last update",
    "soundcloud.likes_caption": (
        "ℹ️ Likes & history reliable since 2026-05-15 "
        "(OAuth user-token collection). S4A/Apple CSV sources not "
