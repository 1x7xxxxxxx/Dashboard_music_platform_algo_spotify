...
EN = {
    ...
    # Step 2 — Credentials
    "onboarding.creds_title": "🔑 Set up your data sources",
    "onboarding.creds_body": "Connect your platforms to start collecting data. "
                             "You can complete this step later from **API Credentials**.",
    "onboarding.connected": "✅ Connected",
    "onboarding.not_configured": "❌ Not configured",
    "onboarding.configure_btn": "Configure →",
