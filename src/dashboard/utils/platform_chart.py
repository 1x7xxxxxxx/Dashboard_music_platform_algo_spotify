...
def render_platform_chart(series: dict, *, title: str = "", days=_DEFAULT_DAYS,
    ...
    # Ce que la hachure, pleine hauteur, ne peut pas dire : QUI n'était pas encore
    # collectée. Une trace invisible par plateforme, sur sa seule préhistoire.
    for _pre in _not_yet_collected_hover(aligned, order, span, PLATFORM_LABELS):
        fig.add_trace(_pre)
